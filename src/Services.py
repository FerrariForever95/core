...
# NOTE: the module file itself is named wifinet.py, NOT network.py --
# MicroPython/ESP32 ships a built-in C-level "network" module (WLAN,
# STA_IF, etc.), and built-in modules always win over a same-named .py
# file on sys.path. Naming this "network" made __import__("network")
# silently resolve to the built-in hardware module instead of this
